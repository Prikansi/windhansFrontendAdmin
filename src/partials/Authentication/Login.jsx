...
import LoginBackground from "../../images/login_background.jpeg";
  ...
  return (
    ...
    >
      <div className="flex items-center shadow-xl bg-[#F4F4F4] gap-8 py-10 px-7">
        <div>
          <img src={LoginBackground} alt="Login" className="h-96" />
        </div>
        <div>
          <Card className="w-[28rem]">
            <p className="font-medium text-[20px] ml-10">Welcome To</p>
            <p className="font-[900] text-[30px] text-[#6358DC] ml-10">
              WindHans Admin
            </p>
